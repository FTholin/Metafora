...
class _CarouselSliderState extends State<CarouselSlider> with TickerProviderStateMixin {
  ...
  Widget addTapDetection(Widget child) =>
  ...
  void tapDetected(){
    pauseOnTouch();
    var currentIndex = _getRealIndex(widget.pageController.page.toInt(), widget.realPage, widget.items.length);
    widget.itemSelected(currentIndex);
  }
